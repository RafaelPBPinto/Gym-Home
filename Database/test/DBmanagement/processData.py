...
def processData():
    ...
    listaExer = 'DocumentosExcel\exercicio.xlsx'
    plaExer = 'DocumentosExcel\ExercicioPlanos.xlsx'
    plano = 'DocumentosExcel\Planos.xlsx'
    sessao = 'DocumentosExcel\Sessao.xlsx'
